...
export default function TrafficMonitoring() {
  ...
  const [zones, setZones] = useState([
    { id: 1, name: 'Oasis Mall Area', latitude: 17.676673, longitude: 75.8986813, vehicles: 342, congestion: 'LOW', signal: 'Green', timer: 45, cam: 'CAM-STN-001', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-traffic-at-night-in-the-city-1189-large.mp4' },
    { id: 2, name: 'Park Shopping Complex - City Corner', latitude: 17.6796, longitude: 75.9088, vehicles: 890, congestion: 'MEDIUM', signal: 'Red', timer: 15, cam: 'CAM-MKT-002', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-daytime-traffic-at-a-busy-intersection-4441-large.mp4' },
    { id: 3, name: 'Virat Mall - Hotgi Road', latitude: 17.6710335, longitude: 75.9418596, vehicles: 756, congestion: 'MEDIUM', signal: 'Red', timer: 60, cam: 'CAM-VJP-003', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-traffic-on-a-highway-with-many-cars-4440-large.mp4' },
    { id: 4, name: 'City Pride - GMR Mall Area', latitude: 17.6743, longitude: 75.9138, vehicles: 1204, congestion: 'HIGH', signal: 'Green', timer: 30, cam: 'CAM-HWY-004', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-cars-on-the-highway-at-night-1192-large.mp4' },
    { id: 5, name: 'Soham Mall - Hospital Stretch', latitude: 17.6644158, longitude: 75.9126046, vehicles: 210, congestion: 'LOW', signal: 'Red', timer: 25, cam: 'CAM-CVL-005', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-intersection-traffic-in-the-city-4444-large.mp4' },
    { id: 6, name: 'Bhuikot Fort - Siddheshwar Area', latitude: 17.6744887, longitude: 75.9021219, vehicles: 950, congestion: 'HIGH', signal: 'Yellow', timer: 5, cam: 'CAM-SQR-006', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-traffic-on-a-busy-street-4439-large.mp4' },
    { id: 7, name: 'Solapur Cancer Center Junction', latitude: 17.656601, longitude: 75.896723, vehicles: 640, congestion: 'MEDIUM', signal: 'Green', timer: 50, cam: 'CAM-ITP-007', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-street-traffic-with-cars-and-buses-4443-large.mp4' },
    { id: 8, name: 'Bharat Mata Nagar - Gangji Mill', latitude: 17.6284768, longitude: 75.9298602, vehicles: 112, congestion: 'LOW', signal: 'Green', timer: 10, cam: 'CAM-BPS-008', videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-highway-traffic-view-from-above-4445-large.mp4' }
  ]);
        ...
        <div className="lg:w-[50%] xl:w-[60%] flex flex-col">
          <div className="bg-[#1E293B] rounded-lg shadow-md h-full min-h-[400px] flex items-center justify-center relative overflow-hidden group border border-slate-700">
            ...
            <video 
               ...
               src={activeZone?.videoUrl || "https://assets.mixkit.co/videos/preview/mixkit-traffic-at-night-in-the-city-1189-large.mp4"} 
               autoPlay 
               loop 
               muted 
